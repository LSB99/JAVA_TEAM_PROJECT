...
public class MainUI {
	...
	public void initialize() {
		...
		/*JRadioButton rdbtnYes = new JRadioButton("  곱빼기");
		...
		JRadioButton rdbtnNo = new JRadioButton("  기본");
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(food.getPay() == null || food.getAmount() == 0 )
					JOptionPane.showMessageDialog(null, "결제수단과 주문하신 음식을 확인해주세요!");
				else {
				dao.foodadd(food);
		...
		button_10.addActionListener(new ActionListener() {
			...
			//	food.setSize(null);
				...
				buttonGroup_2.clearSelection(); 
				System.out.println(food);
				JOptionPane.showMessageDialog(null, "선택취소 되었습니다.");
